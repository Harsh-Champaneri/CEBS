...
if (isset($_SESSION["user_id"])) {
    $_SESSION["active_page"] = "MyEvents";  // Current Page Name
...
<body>
    ...
    <section class="dashboard-hero" style="padding: 50px">
        ...
        ">
            <div>
                <h2 class="section-title mb-2">My Events</h2>
                <p class="section-subtitle m-0">
                    View all your created events and stay updated with their latest status
                </p>
            </div>
