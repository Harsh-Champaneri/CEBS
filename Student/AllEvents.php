...
if (isset($_SESSION["user_id"])) {
    $_SESSION["active_page"] = "AllEvents"; // Current Page Name
...
<body>
    ...
    <section class="dashboard-hero" style="padding: 50px;">
        <!-- 🔹 Hero Title Section -->
        <div class="container text-left" style="display: flex; flex-direction: row; justify-content: space-between;">
            <div>
                <h2 class="section-title mb-2">All Events</h2>
